...
<script type="text/javascript">
 ...
 <body>
 <br><br><center><h3><font color="white"> Bill Still Pending: </font></h3></center>

 
	  
    
	  <?php
					$qur=mysqli_query($con,"select * from Maintenance_Bill where Status='0' order by Flat_No");
					if(mysqli_num_rows($qur)>0)
					{
						echo "<br><br><br><center><font color='white'><table class='table table-bordered' border ='1px' style='background-color:rgba(0,0,0,0.5)'>
								<tr>
