...
<style type="text/css">
   ...
   <section  class="tm-section-pad-top tm-parallax-2">
     <div class="container tm-container-contact">
        <div class="row" style="justify-content: space-evenly">
            ...
            style="display: flex; justify-content: center; flex-direction: column; align-items: center;">
                                    <h2 class="mb-4 tm-section-title"><font color="white"><br><br><b>Maintenance Bill Pay</b></font></h2>
	...
	?>
	 ...
	 <button type="submit" class="btn tm-btn-submit" name="Check">Check Status</button>
	  </form>
		</div>
		</div>
		</div>
...
{
			$Fno=$_POST['Fno'];		
					$qur2=mysqli_query($con,"select * from Maintenance_Bill where Flat_No='$Fno'");
					if(mysqli_num_rows($qur2)>0)
					{
						echo "<br><br><br><center><font color='black'><table class='table table-bordered' border='1px' style='background-color:white' >
							...
							while($q=mysqli_fetch_array($qur2))
							{
							echo "<tr>";
							...
							echo "<td><a href='bill.php?bMid={$q['MB_ID']}'>Generate Bill</a></td>";
